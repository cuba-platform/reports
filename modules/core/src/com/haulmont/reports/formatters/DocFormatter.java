...
import com.haulmont.reports.formatters.doctags.BitmapTagHandler;
import com.haulmont.reports.formatters.doctags.HtmlContentTagHandler;
import com.haulmont.reports.formatters.doctags.ImageTagHandler;
...
import com.haulmont.reports.formatters.doctags.TagHandler;
import com.haulmont.reports.formatters.oo.*;
...
import static com.haulmont.reports.formatters.oo.ODTTableHelper.*;
import static com.haulmont.reports.formatters.oo.ODTUnoConverter.*;
...
public class DocFormatter extends AbstractFormatter {
     ...
     */
    private static List<TagHandler> tagHandlers = new ArrayList<>();
    ...
    private void connectToOffice() {
        String openOfficePath = AppBeans.get(Configuration.class).getConfig(ReportingConfig.class).getOpenOfficePath();
        try {
     ...
     *
     * @throws com.haulmont.reports.exception.ReportingException If alias is bad or not found in bands
     *
     */
    ...
    private void fillTable(String name, Band parentBand, XTextTable xTextTable, XDispatchHelper xDispatchHelper)
        ...
        boolean displayDeviceUnavailable = reportingConfig.getDisplayDeviceUnavailable();
     ...
     *
     * @throws com.haulmont.reports.exception.ReportingException If there is not appropriate band or alias is bad
     */
