...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_REPORT_TO_REPORT_BAND_DEFINITION')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_BAND_DEFINITION_TO_REPORT_REPORT')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_TEMPLATE_TO_REPORT')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPOR_INPUT_PARAMETER_TO_REPORT_REPORT')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_DATA_SET_TO_REPORT_BAND_DEFINITION')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_REPORTS_ROLES_TO_REPORT')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_REPORT_SCREEN_TO_REPORT_REPORT')
    BEGIN
...
if exists (SELECT * FROM INFORMATION_SCHEMA.REFERENTIAL_CONSTRAINTS WHERE CONSTRAINT_NAME ='FK_REPORT_VALUE_FORMAT_TO_REPORT_REPORT')
    BEGIN
